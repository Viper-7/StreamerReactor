...
$si = new phpMQTT($service['Host'], $service['Port'] ?: 1883, 'r' . microtime(true));
$si->connect(true, null, '', '');
$si->publish('event/' . $broadcaster_user_id . '/' . $event_type, rendertemplate($value_template));
$si->close();
